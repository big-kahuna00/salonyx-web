        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('service_id', $services, null, ['class' => 'form-control select2', 'required' => '', 'name' => 'services[]']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('service_id', 'Location*', ['class' => 'control-label']) !!}
                    {!! Form::select('service_id', $locations, null, ['class' => 'form-control select2', 'required' => '', 'name' => 'location_id']) !!}
                    <p class="help-block"></p>
